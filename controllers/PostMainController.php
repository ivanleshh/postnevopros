...
/**
 * PostMainController implements the CRUD actions for Post model.
 */
class PostMainController extends Controller
{
    ...
    {
        $searchModel = new PostMainSearch();
     ...
     */
    public function actionView($id, $like = null)
    {
